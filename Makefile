...
all: info check_vms main k8scontrol kube_client k8sjoin helm metrics octant k9s storage

info check_vms main k8scontrol kube_client k8sjoin helm metrics octant k9s storage k8sunjoin:
	$(YAMLLINT)
	$(ANSIBLELINT)
	$(PLAYBOOK)
