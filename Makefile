...
all: info check_vms main k8scontrol kube_client k8sjoin metrics octant k9s storage crictl

info check_vms main k8scontrol kube_client k8sjoin metrics octant k9s storage crictl k8sunjoin:
	$(YAMLLINT)
	$(ANSIBLELINT)
	$(PLAYBOOK)
